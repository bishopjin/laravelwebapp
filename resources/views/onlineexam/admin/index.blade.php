                                ...
                                <tbody>
                                    @forelse($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" 
                                                    action="{{ route('adminexam.destroy', ['adminexam' => $user->id]) }}">

                                                    @csrf
                                                    @method('DELETE')

                                                    <input type="submit" 
                                                        value="@if($user->trashed()) Enable Account @else Disable Account @endif" 
                                ...
                                <tbody>
                                    @forelse($subjects as $subject)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" 
                                                    class="btn btn-outline-success editSubject" 
                                                    id="{{ $subject->id }}">
                                                    {{ __('Edit') }}
                                                </button>
                                            </td>
