                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="fw-bold fs-5">
                                        {{ __('Student Name: ') }}
                                        {{ $examResult[0]->student->full_name }}
                                    </div>
                                    <hr>
                                    @forelse($examResult as $result)
                                        <div class="p-2 mb-2 border border-warning rounded">
                                            <div>
                                                <span class="fw-bold">
                                                    {{ __('Examination Code : ') }}
                                                </span> 
                                                {{ $result->onlineexam->exam_code }}
                                            </div>
                                            <div>
                                                <span class="fw-bold">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ url()->previous() }}" 
                                            class="btn btn-outline-primary px-md-5 px-2 my-2">
                                            {{ __('Back') }}
                                        </a>
                                    </div>
                                </div>
