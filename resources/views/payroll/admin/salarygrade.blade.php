		...
		<div class="row justify-content-center">
			<div class="col-md-6">
				<div class="card shadow">
					...
					<div class="card-body">
						<form method="POST" 
							action="{{ route('salarygrade.store') }}" 
							class="px-5">
							...
							<div class="form-group pb-3">
								...
								<input type="text" 
									...
									id="salary_grade" 
									value="{{ $slrygrd ?? old('salary_grade') }}" 
									{{ $slrygrd ? 'readonly' : '' }}>
                ...
                @enderror
							...
							<div class="form-group pb-3">
								<input type="checkbox" 
									name="night_diff_applied" 
									id="nightdiff" value="1" 
									class="form-check-input"
									{{ $nghtdffppld == 1 ? 'checked' : '' }}>

								<label class="form-check-label" 
									for="nightdiff">
									{{ __('Night Differentials') }}
								</label>
							</div>

							<div class="form-group pb-3">
								<input type="checkbox" 
									name="overtime_applied" 
									id="isovertime" value="1" 
									class="form-check-input"
									{{ $vrtmppld == 1 ? 'checked' : '' }}>
							...
							<div class="form-group pb-3">
								...
								<label class="form-check-label" 
									for="isecola">
									{{ __('Emergency Cost of living allowance') }}
								</label>
							</div>

							<div class="form-group pb-3">
								<input type="checkbox" 
									name="meal_allowance_applied" 
									id="ismeal" value="1" 
									class="form-check-input"
