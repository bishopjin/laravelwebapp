			...
			<div class="col-md-6">
				<div class="card shadow">
					...
					<div class="card-body">
						...
						<form method="POST" 
							action="@if ($sched_id) 
												{{ route('payrollschedule.update', $workschedule->id) }} 
											@else
												{{ route('payrollschedule.store') }} 
											@endif" 
							class="px-5">
							@csrf
                ...
                @enderror
							...
							<div class="d-flex flex-column flex-md-row justify-content-md-between">
								<div class="form-group pb-2">
									...
									<input type="time" 
										name="startTme" 
										class="form-control @error('startTme') is-invalid @enderror" 
										id="startTme" 
										value="{{ $startDT ?? old('startTme') ?? date('H:i') }}">
                  ...
                  @enderror
								...
								<div class="form-group pb-2">
									...
									<input type="time" 
										name="endTme" 
										class="form-control @error('endTme') is-invalid @enderror" 
										id="endTme" 
										value="{{ $endDT ?? old('endTme') ?? date('H:i') }}">
